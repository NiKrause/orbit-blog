...
import { postsDB, categories, selectedPostId, identity } from "../store";
...
function renderMarkdown(content2) {
  const rawHtml = marked(content2);
...
async function removeSelectedMedia(mediaId) {
